...
def evolve_and_plot(u_init, c, time_steps, advection_scheme_key):
...
if __name__ == "__main__":
    ...
    u_init = setup.initial_condition(x_grid, init_curve, arguments_initial_cond)
    ...
    for advection_scheme_key in advection_scheme_key_list:
        evolve_and_plot(u_init, c, time_steps, advection_scheme_key)
